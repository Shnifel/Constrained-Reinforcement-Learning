...
def main(game, representation, experiment, steps, n_cpu, render, logging, **kwargs):
    ...
    if not resume:
        ...
        source_file = "/home-mscluster/lkerker/RL-Research/gym-pcgrl/runs/zelda_wide_1_log/0.monitor.csv"
        destination = "/home-mscluster/lkerker/RL-Research/gym-pcgrl/runs/zelda_wide_1_log/copy.csv"
