...
# def get_range_reward(new_value, old_value, low, high):
#     def calculate_proportional_reward(value, boundary, is_low):
#         if is_low:
#             return max(0, 1 - (boundary - value) / abs(low - high))
#         else:
#             return max(0, 1 - (value - boundary) / abs(high - low ))




#     # Case 1: Both old and new values are within the range.
#     if low <= new_value <= high and low <= old_value <= high:
#         return 1  
#     #case 2: New value is within range
#     if low <= new_value <= high:
#         return 1
#     #case 3: New value moves out of range above  
#     if low <= old_value <= high and new_value >high:
#         return calculate_proportional_reward(new_value,high,False) - 1
#     #case 4: New value moves out of range below  
#     if low <= old_value <= high and new_value <low:
#         return calculate_proportional_reward(new_value,low,True) - 1
#     #case 5: New_value and old_value are below low
#     if old_value <= low and new_value <= low:
#         if new_value < old_value:
#             return calculate_proportional_reward(new_value,low,True) - calculate_proportional_reward(old_value,low,True)
#         elif new_value == old_value:
#             return calculate_proportional_reward(new_value,low,True) - 1
#         else:
#             return calculate_proportional_reward(new_value,low,True)
#     #case 6: New_value and old_value are above high
#     if old_value >= high and new_value >= high:
#         if new_value > old_value:
#             return  calculate_proportional_reward(new_value,high,False) - calculate_proportional_reward(old_value,high,False)
#         elif new_value == old_value:
#             return calculate_proportional_reward(new_value,high,False) - 1
#         else:
#             return calculate_proportional_reward(new_value,high,False)
#     #case 7: over shoots boundary
#     if new_value > high and old_value < low:
#         return calculate_proportional_reward(new_value,high,False) - 1
#     #case 8: over shoots boundary
#     if new_value < low and old_value > high:
#         return calculate_proportional_reward(new_value,low,True) - 1
...
# def get_range_reward_pkd(new_value, old_value, low, high):
#     if low == new_value == high and low == old_value == high:
#         return 1  
#     elif new_value == low:
#         return 1
